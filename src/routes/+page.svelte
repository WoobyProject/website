<header class="w-full">
	<enhanced:img src="$lib/assets/characters/three.svg" alt="Wooby Logo with decorations" class="block mx-auto w-[60%] max-w-5xl my-15"/>
</header>
<button class="block mx-auto my-15 text-4xl">Contact us</button>
<section class="stripe py-5">
...
<section class="stripe py-5" style="--bg-color: var(--bg-yellow)">
	<h1>The stories</h1>
